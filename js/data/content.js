...
export const ITEMS={
 Hint:{icon:'💡',price:250,desc:'Remove one incorrect answer.'},'Mega Hint':{icon:'✨',price:1200,desc:'Remove two incorrect answers.'},'Double XP':{icon:'⚡',price:2500,desc:'2× XP for the current run.'},'Score Boost':{icon:'⭐',price:3200,desc:'2× score for the current run.'},'Second Chance':{icon:'❤️',price:4000,desc:'Restore one lost life.'},'Extra Lives':{icon:'💖',price:5500,desc:'+2 lives for the current run.'},'Lucky Answer':{icon:'🍀',price:8000,desc:'Automatically answers the current question correctly.'},'Time Freeze':{icon:'❄️',price:6500,desc:'Freeze the timer for 5 seconds.'},'Coin Magnet':{icon:'🪙',price:10000,desc:'+50% coins for the current run.'},'Boss Slayer':{icon:'⚔️',price:15000,desc:'+50% boss damage for the current battle.'},'Boss Damage':{icon:'💥',price:11000,desc:'+50% boss damage for the current battle.'},'Streak Shield':{icon:'🛡️',price:18000,desc:'Protect one Streak Mode mistake.'},'Rank Boost':{icon:'📈',price:25000,desc:'+25 bonus rating for a completed Ranked run.'},'World Scanner':{icon:'🌐',price:30000,desc:'Reveals one clue category in Hardcore.'},'Boss Token':{icon:'🪙',price:0,desc:'Boss-exclusive: +500 coins.',bossOnly:true},'Mythic Fang':{icon:'🦷',price:0,desc:'Boss-exclusive: +100% boss damage.',bossOnly:true},'Divine Core':{icon:'💎',price:0,desc:'Boss-exclusive: +1000 XP and +1000 coins.',bossOnly:true},'Cosmic Shard':{icon:'🌌',price:0,desc:'Cosmic reward. +5000 XP and +5000 coins.',bossOnly:true}
};
export const SKINS={
 Explorer:{price:0,xp:1,coins:1,time:0,drop:1,rarity:'common',power:'Starter'},
 Scout:{price:7500,xp:1.1,coins:1.12,time:1,drop:1.05,rarity:'rare',power:'Quick Learner'},
 Champion:{price:25000,xp:1.3,coins:1.28,time:2,drop:1.15,rarity:'epic',power:'Score Hunter'},
 Mythic:{price:90000,xp:1.6,coins:1.55,time:3,drop:1.4,rarity:'mythic',power:'Mythic Focus'},
 Divine:{price:300000,xp:2.1,coins:2,time:5,drop:1.8,rarity:'divine',power:'Divine Fortune'},
 Transcendent:{price:1500000,xp:3,coins:3,time:8,drop:2.5,rarity:'transcendent',power:'Transcendent Mind'},
 Cosmic:{price:25000000,xp:4.5,coins:4,time:12,drop:4,rarity:'cosmic',power:'Cosmic Knowledge'},
 '👑 OWNER':{price:0,xp:10001,coins:10001,time:999,drop:11,rarity:'cosmic',owner:true,lives:9999,power:'Developer'}
};
export const CHEST_PRICES={Common:1000,Rare:4000,Epic:15000,Legend:50000,Mythic:180000,Divine:750000,Transcendent:8000000,Cosmic:80000000};
...
export const UPGRADES={
 'Coin Engine':{icon:'🪙',base:50000,step:1.15,desc:'+5% coins per level.',max:10},
 'XP Engine':{icon:'✨',base:65000,step:1.15,desc:'+5% XP per level.',max:10},
 'Time Core':{icon:'⏱️',base:90000,step:1.2,desc:'+1 second per question in non-ranked modes.',max:5},
 'Streak Core':{icon:'🔥',base:120000,step:1.2,desc:'+5% Streak rewards.',max:10}
};
export const RULES=['All previous game modes remain available.','Classic keeps Easy, Normal, Hard, Extreme and Nightmare.','Hardcore is a Classic variant: 1 life, no hints and mixed knowledge questions.','Streak Mode ends immediately when you answer incorrectly or run out of time.','Ranked is a 10-question Elo climb. Questions become harder as you progress.','Ranked uses rating instead of the old level-based rank system. Level is now progression and unlocks rewards/perks.','Cosmic Chests are the rarest chest and cost far more than Transcendent Chests.','Bosses can reward coins, XP, chests, skins and boss-exclusive items.','Profiles are migrated from v3.5.5 and older local saves.','Country metadata is refreshed from a live country-data service when available.','Owner Panel is a developer/testing tool and requires the V4 password.'];
